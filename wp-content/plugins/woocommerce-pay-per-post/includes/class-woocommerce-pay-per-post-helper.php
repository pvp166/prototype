...
class Woocommerce_Pay_Per_Post_Helper extends Woocommerce_Pay_Per_Post {
    ...
    public static function has_access( $post_id = null, bool $track_page_view = true ) : bool {
        Woocommerce_Pay_Per_Post_Helper::logger( 'Post ID: ' . get_the_ID() . ' - Woocommerce_Pay_Per_Post_Helper::has_access  - BACKTRACE - Called From - ' . print_r( debug_backtrace()[1]['function'], true ) );
