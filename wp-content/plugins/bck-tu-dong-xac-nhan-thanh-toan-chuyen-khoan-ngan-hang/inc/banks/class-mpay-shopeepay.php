...
class WC_Gateway_Mpay_Shopeepay extends WC_Base_Mpay {
	public function __construct() {
		...
		$this->method_description = __('Payment by bank transfer. The system automatically confirms the paid order after the transfer is completed.', 'bck-verify-bank-transfer');
